...
{
    	Gtk::Dialog namedialog("Enter name:");
    	Gtk::Entry entry;
	
	//namedialog.set_message("Enter your name.");
   	namedialog.add_button(Gtk::StockID(Gtk::Stock::OK), Gtk::RESPONSE_OK);
		...
		case Gtk::RESPONSE_OK:
        		std::cout << "Name accepted! Welcome to Simon's farm!"<<std::endl;
        		username = entry.get_text();

        	
       	 	if(username.length() == 0) {
            		std::cout << "Person is Nameless!!!";
            		break;
        	}
        	...
        	std::cout << "Person is Nameless!"; break;
    default:
        std::cout << "Player apparently has no name."; break;
    }
}
